#!/bin/bash
# Thank you Sathish Arthar for another great script.
# simple menu driven shell script to to get information about your Linux server / desktop 
# and do some Users and File operations quickly.

# Python Offensive PenTesting: - All rights reserved Nathan W Jones nathan.jones@arcadeusops.com

# don't forget to chmod 755 sysinfo.sh
# usgage is ./sysinfo.sh 
